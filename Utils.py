...
from src.Models import get_non_pad_mask
...
def log_likelihood(model, data, time, types,bi):
    ...
    all_lambda = softplus(all_hid, model.beta[bi])
    ...
    non_event_ll = 0#compute_integral_unbiased(model, data, time, non_pad_mask, type_mask)
    # non_event_ll = torch.sum(non_event_ll, dim=-1)

    return event_ll, non_event_ll,all_lambda
